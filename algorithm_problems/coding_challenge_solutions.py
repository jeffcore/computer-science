...
def mergeTwoLists(l1, l2):
    ...
    if list_node1.val <= list_node2.val:           
        new_list = ListNode(list_node1.val) 
        new_list_temp = new_list       
        list_node1 = list_node1.next
    else:
        new_list =  ListNode(list_node2.val)
        new_list_temp = new_list   
    ...
    while list_node1 or list_node2:
        ...
        if list_node1 is None:
            new_list_temp.next = ListNode(list_node2.val)
            new_list_temp = new_list_temp.next
            list_node2 = list_node2.next 
        elif list_node2 is None:
            new_list_temp.next = ListNode(list_node1.val)
            new_list_temp = new_list_temp.next
            list_node1 = list_node1.next
        elif list_node1.val <= list_node2.val:
            print('got here')          
            new_list_temp.next = ListNode(list_node1.val)
            new_list_temp = new_list_temp.next
            list_node1 = list_node1.next
